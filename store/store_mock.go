...
func (m *MockGenericInterface) Get(ctx context.Context, key string) (*T, error) {
	m.ctrl.T.Helper()
...
func (mr *MockGenericInterfaceMockRecorder) Get(ctx, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockGenericInterface)(nil).Get), ctx, key)
}

// Set mocks base method.
func (m *MockGenericInterface) Set(ctx context.Context, key string, value T) error {
	m.ctrl.T.Helper()
...
func (m *MockGenericInterface) Update(ctx context.Context, key string, fn func(*T)) error {
	m.ctrl.T.Helper()
